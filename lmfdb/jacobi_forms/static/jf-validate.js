...
function index ( input) {
    ...
    var tmp = normalize( input);
    labels = tmp[0];
    tmp = lattice_parser.parse( tmp[1]);
    var defs = {};

    for ( var i = 0; i < labels.length; i++) {
	defs[ labels[i]] = tmp[i][1];
    }
    return defs;
}
...
function normalize( inp) {
	...
	case "read":
	    if ( c == col) {
		buf = buf.trim();
		if ( buf.length == 0)  throw "':' without preceding name in " + inp;
		labels.push( buf);
		buf = "";
		state = "get_def";
	    }
		...
		buf = buf.trim();
		if ( buf.length == 0)  throw "',' without preceding lattice definition in " + inp;
		labels.push( buf);
		defs += buf;
		if ( c == sep) defs += sep;
		buf = "";
	...
	case "get_def":
	    if ( c == col) throw "too many ':' in " + input;
	    if ( c == sep | c == eos) {
		buf = buf.trim();
		if ( buf.length == 0)  throw "',' without preceding lattice definition in " + inp;
		defs += buf;
...
exports.parser = character_parser;
exports.Parser = character_parser.Parser;
exports.parse = function () { return character_parser.parse.apply(character_parser, arguments); };
...
/******************************************************************************/
/******************* The lattice definitions parser ***************************/
/******************************************************************************/
...
*/
var lattice_parser = (function(){
var parser = {trace: function trace(){},
yy: {},
symbols_: {"error":2,"lat_seq":3,"lat":4,"NAME":5,":":6,",":7,"EOF":8,"INT":9,"[":10,"seq":11,"]":12,"STRING":13,"<":14,">":15,"(":16,")":17,"*":18,"+":19,"$accept":0,"$end":1},
terminals_: {2:"error",5:"NAME",6:":",7:",",8:"EOF",9:"INT",10:"[",12:"]",13:"STRING",14:"<",15:">",16:"(",17:")",18:"*",19:"+"},
productions_: [0,[3,1],[3,3],[3,3],[3,5],[3,2],[4,1],[4,3],[4,1],[4,4],[4,3],[4,3],[4,3],[11,1],[11,2]],
performAction: function anonymous(yytext, yyleng, yylineno, yy, yystate /* action[1] */, $$ /* vstack */, _$ /* lstack */
/**/) {
/* this == yyval */
...
var $0 = $$.length - 1;
switch (yystate) {
case 1:this.$ = [[String($$[$0]),$$[$0]]];
break;
case 2:this.$ = [[$$[$0-2],$$[$0]]];
break;
case 3:this.$ = $$[$0-2].concat([[$$[$0].toString(),$$[$0]]]);
break;
case 4:this.$ = $$[$0-4].concat([[$$[$0-2],$$[$0]]]);
break;
case 5:return $$[$0-1];
break;
case 6:this.$ = parseInt(yytext);
break;
case 7:this.$ = $$[$0-1];
break;
case 8:this.$ = yytext;
break;
case 9:this.$ = ["r", $$[$0-3], parseInt($$[$0-1])];
break;
case 10:this.$ = $$[$0-1];
break;
case 11:this.$ = ["s", $$[$0], parseInt($$[$0-2])];
break;
case 12:this.$ = ["+", $$[$0-2], $$[$0]];
break;
case 13:this.$ = [ parseInt(yytext) ];
break;
case 14:this.$ = $$[$0-1].concat(parseInt($$[$0]));
break;
}
},
table: [{3:1,4:2,5:[1,3],9:[1,4],10:[1,5],13:[1,6],16:[1,7]},{1:[3],7:[1,8],8:[1,9]},{1:[2,1],7:[2,1],8:[2,1],14:[1,10],19:[1,11]},{6:[1,12]},{1:[2,6],7:[2,6],8:[2,6],14:[2,6],17:[2,6],18:[1,13],19:[2,6]},{9:[1,15],11:14},{1:[2,8],7:[2,8],8:[2,8],14:[2,8],17:[2,8],19:[2,8]},{4:16,9:[1,4],10:[1,5],13:[1,6],16:[1,7]},{4:17,5:[1,18],9:[1,4],10:[1,5],13:[1,6],16:[1,7]},{1:[2,5],7:[2,5],8:[2,5]},{9:[1,19]},{4:20,9:[1,4],10:[1,5],13:[1,6],16:[1,7]},{4:21,9:[1,4],10:[1,5],13:[1,6],16:[1,7]},{4:22,9:[1,4],10:[1,5],13:[1,6],16:[1,7]},{9:[1,24],12:[1,23]},{9:[2,13],12:[2,13]},{14:[1,10],17:[1,25],19:[1,11]},{1:[2,3],7:[2,3],8:[2,3],14:[1,10],19:[1,11]},{6:[1,26]},{15:[1,27]},{1:[2,12],7:[2,12],8:[2,12],14:[1,10],17:[2,12],19:[2,12]},{1:[2,2],7:[2,2],8:[2,2],14:[1,10],19:[1,11]},{1:[2,11],7:[2,11],8:[2,11],14:[1,10],17:[2,11],19:[2,11]},{1:[2,7],7:[2,7],8:[2,7],14:[2,7],17:[2,7],19:[2,7]},{9:[2,14],12:[2,14]},{1:[2,10],7:[2,10],8:[2,10],14:[2,10],17:[2,10],19:[2,10]},{4:28,9:[1,4],10:[1,5],13:[1,6],16:[1,7]},{1:[2,9],7:[2,9],8:[2,9],14:[2,9],17:[2,9],19:[2,9]},{1:[2,4],7:[2,4],8:[2,4],14:[1,10],19:[1,11]}],
defaultActions: {},
parseError: function parseError(str,hash){if(hash.recoverable){this.trace(str)}else{throw new Error(str)}},
parse: function parse(input) {
    var self = this, stack = [0], vstack = [null], lstack = [], table = this.table, yytext = '', yylineno = 0, yyleng = 0, recovering = 0, TERROR = 2, EOF = 1;
...
rules: [/^(?:\s+)/,/^(?:-?[0-9]+)/,/^(?:\*)/,/^(?:\+)/,/^(?:\()/,/^(?:\))/,/^(?:\[)/,/^(?:\])/,/^(?:<)/,/^(?:>)/,/^(?:(A_|B_|C_|D_|Z\^)[1-9]+[0-9]*|E_6|E_7|E_8|G_2|F_4|Z\b)/,/^(?:[a-z]+)/,/^(?:,)/,/^(?::)/,/^(?:$)/,/^(?:.)/],
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
exports.parser = lattice_parser;
exports.Parser = lattice_parser.Parser;
exports.parse = function () { return lattice_parser.parse.apply(lattice_parser, arguments); };
exports.main = function commonjsMain(args){if(!args[1]){console.log("Usage: "+args[0]+" FILE");process.exit(1)}var source=require("fs").readFileSync(require("path").normalize(args[1]),"utf8");return exports.parser.parse(source)};
if (typeof module !== 'undefined' && require.main === module) {
  exports.main(process.argv.slice(1));
}
...
*/
var weight_parser = (function(){
var parser = {trace: function trace(){},
yy: {},
symbols_: {"error":2,"expressions":3,"e":4,"EOF":5,"INT":6,"+":7,",":8,"HALFINT":9,"$accept":0,"$end":1},
terminals_: {2:"error",5:"EOF",6:"INT",7:"+",8:",",9:"HALFINT"},
productions_: [0,[3,1],[3,2],[3,2],[4,5],[4,5],[4,5],[4,5],[4,3],[4,3],[4,1],[4,1]],
performAction: function anonymous(yytext, yyleng, yylineno, yy, yystate /* action[1] */, $$ /* vstack */, _$ /* lstack */
/**/) {
/* this == yyval */
...
break;
case 5:this.$ = [parseFloat($$[$0-4]),parseInt($$[$0-2]),parseInt($$[$0])];
break;
case 6:this.$ = [parseFloat($$[$0-4]),parseInt($$[$0-2]),parseFloat($$[$0])];
break;
case 7:this.$ = [parseInt($$[$0-4]),parseInt($$[$0-2]),parseFloat($$[$0])];
break;
case 8:this.$ = [parseInt($$[$0-2]),parseInt($$[$0])];
break;
case 9:this.$ = [parseFloat($$[$0-2]),parseInt($$[$0])];
break;
case 10:this.$ = [parseInt($$[$0])];
break;
case 11:this.$ = [parseFloat($$[$0])];
break;
}
},
table: [{3:1,4:2,6:[1,3],9:[1,4]},{1:[3],4:5,5:[1,6],6:[1,3],9:[1,4]},{1:[2,1],5:[2,1],6:[2,1],9:[2,1]},{1:[2,10],5:[2,10],6:[2,10],7:[1,7],9:[2,10]},{1:[2,11],5:[2,11],6:[2,11],7:[1,8],9:[2,11]},{1:[2,2],5:[2,2],6:[2,2],9:[2,2]},{1:[2,3],5:[2,3],6:[2,3],9:[2,3]},{6:[1,9]},{6:[1,10]},{1:[2,8],5:[2,8],6:[2,8],8:[1,11],9:[2,8]},{1:[2,9],5:[2,9],6:[2,9],8:[1,12],9:[2,9]},{6:[1,13],9:[1,14]},{6:[1,15],9:[1,16]},{1:[2,4],5:[2,4],6:[2,4],9:[2,4]},{1:[2,7],5:[2,7],6:[2,7],9:[2,7]},{1:[2,5],5:[2,5],6:[2,5],9:[2,5]},{1:[2,6],5:[2,6],6:[2,6],9:[2,6]}],
defaultActions: {},
parseError: function parseError(str,hash){if(hash.recoverable){this.trace(str)}else{throw new Error(str)}},
parse: function parse(input) {
    var self = this, stack = [0], vstack = [null], lstack = [], table = this.table, yytext = '', yylineno = 0, yyleng = 0, recovering = 0, TERROR = 2, EOF = 1;
...
if (typeof require !== 'undefined' && typeof exports !== 'undefined') {
exports.parser = weight_parser;
exports.Parser = weight_parser.Parser;
exports.parse = function () { return weight_parser.parse.apply(weight_parser, arguments); };
exports.main = function commonjsMain(args){if(!args[1]){console.log("Usage: "+args[0]+" FILE");process.exit(1)}var source=require("fs").readFileSync(require("path").normalize(args[1]),"utf8");return exports.parser.parse(source)};
if (typeof module !== 'undefined' && require.main === module) {
  exports.main(process.argv.slice(1));
}
